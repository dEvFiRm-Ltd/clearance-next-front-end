      ...
      <form method="post">
        <ModalBody modalBodyClass="flex flex-row gap-x-3">
          ...
          <div className="w-[458px] pl-2">
            <p className="text-xl leading-6 line-clamp-2 capitalize text-black-primary font-medium">
            ...
            <div className="flex flex-row justify-between items-center">
              <div className="flex flex-row items-center gap-3 mt-4">
                ...
                <p className="bg-black-primary text-xs text-white px-[2px]">
                  -13%
                </p>
              </div>
              <Link
            ...
            <div className="flex flex-col justify-start items-start gap-y-3">
              ...
              <div className="flex flex-row justify-between gap-x-4 w-full">
                <Button
                  ...
                  btnText="Add to cart"
                  variant="primary"
                  btnClass="hover:!opacity-90 !text-lg !font-bold !w-[72%] rounded"
                />
                <Button
                  actionCb={() => {}}
                  btnText="Buy it now"
