...
const FlashSale: FC<flashSaleProps> = ({ flashSaleArr }) => {
  ...
  return (
    <section className='mx-auto container w-full px-4 lg:px-2 py-2 md:py-5 md:w-full xl:w-[1080px] 2xl:w-[1416px] !font-[Helvetica]'>
      <Title />
          ...
          >
            {flashSaleArr.map((item: any) => (
              <SwiperSlide key={item.id}>
                <FlashSaleCard
                  img={'https://www.stylewe.com/image_cache/resize/335x445/image/catalog/product/2022-10-18/e0eba04196313a4cd8473605900e7cb8.jpg'}
                  text={item.name}
