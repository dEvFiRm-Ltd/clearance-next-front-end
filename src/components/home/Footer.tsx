  ...
  return (
    <div className="bg-[#f1f2f3] py-5 xl:px-5 px-3 3xl:px-0">
      <div className="container">
        <div className="flex flex-col lg:flex-row flex-wrap justify-start gap-x-5 !font-[Helvetica]">
        ...
        <div className="xl:mt-5">
          <div className="flex items-center flex-wrap px-4 mt-5 xl:justify-center">
            <div className="w-[16px] h-[16px] xl:w-[40px] xl:h-[40px] relative mx-[12.5px] mb-4">
              <Image
                fill
                className=""
                alt="Paypal"
          ...
          <p className="text-center font-normal text-sm text-[#8c8c8c] mt-1 ">
            &copy; 2023 Clearance
          </p>
        </div>
      </div>
