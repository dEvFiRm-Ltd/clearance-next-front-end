...
const MiddleHeader = () => {
  ...
  return (
    <div className="hidden w-full lg:flex flex-row justify-between items-center py-[18px] px-[60px]">
      <Link
        href={"/"}
      ...
      <div className="w-[572px] flex flex-row justify-start items-center gap-x-8">
