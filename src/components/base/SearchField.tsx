...
const SearchField: FC<searchFieldProps> = ({ onFocus, onBlur }) => {
  ...
  return (
    ...
    >
      <div className="w-[300px] flex flex-row justify-start items-center border border-ash pr-4">
        <input
          ref={searchInputRef}
          type="text"
          value={searchValue}
          placeholder={local === "en" ? "Jacket" : "السترة"}
          className="px-3 outline-none py-2.5 2xl:py-3 text-sm leading-[26px] w-full"
      ...
      <Button
        ...
        btnClass="hover:bg-[#616368] !px-7 !py-2.5 2xl:!py-3 !w-auto"
      />
    </form>
  );
};
