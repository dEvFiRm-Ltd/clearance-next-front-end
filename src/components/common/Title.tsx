...
const Title = () => {
  ...
  return (
    <div className="w-full flex flex-col lg:flex-row lg:justify-between justify-start gap-y-5 items-center px-10 mx-auto container pt-5 lg:pb-4">
      ...
      <div className="flex flex-row justify-center">
        ...
        <Link
          href={""}
          className="hidden bg-[#ffffff88] lg:h-9 lg:w-9 2xl:h-10 2xl:w-10 rounded-full mt-[1%] 2xl:mt-[1.5%] lg:flex justify-center items-center text-gray-800 "
        >
