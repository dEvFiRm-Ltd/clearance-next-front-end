...
const FilterItem:FC<filterType> = ({title,actionCb,icon,labels,actionCbView,viewStateCb}) => {
  ...
  return (
    ...
    {viewStateCb && 
      ...
      <button type='button' onClick={actionCbView} className='mb-[21px] mt-6 py-2 flex w-full justify-start items-center font-medium gap-x-1 text-[14px] leading-[17px] text-black' onClick={()=>{}}>
